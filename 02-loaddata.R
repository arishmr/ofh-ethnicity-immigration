...
factorcols <- c("pid", "ethnicity", "immigration", "immigrate_stage", "sex", "income", "alcohol", "depression", "currdep", "fatherpsych", "motherpsych")
...
## Convert the following variables to logical: depression, currdep, undiagdep, smoking, fatherpsych, motherpsych
logcols <- c("depression", "currdep", "undiagdep", "smoking", "fatherpsych", "motherpsych")
